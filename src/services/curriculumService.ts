...
export class CurriculumService {
  ...
  public static async fetchCurriculums(
    idPerfil: number
  ): Promise<CurriculumResponse | CurriculumResponseError> {
    try {
      const response = await fetch(
        `${apiUrl}/candidate/curriculums/perfil/${idPerfil}`,
        {
          method: "GET",
          headers: {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Error desconocido al cargar los CVs",
      } as CurriculumResponseError;
    }
  }
   ...
   */
  public static async createCurriculum(
    curriculumData: Omit<Curriculum, "id_curriculum" | "fecha_subida">
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Error desconocido al crear el CV",
      };
    }
  }
   ...
   */
  public static async updateCurriculumName(
    idCurriculum: number,
    nuevoNombre: string
  ): Promise<CurriculumUploadResult> {
    try {
      const response = await fetch(
        `${apiUrl}/candidate/curriculums/${idCurriculum}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Error desconocido al actualizar el nombre",
      };
    }
  }
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Error desconocido al eliminar el CV",
      };
    }
  }
   ...
   */
  public static async uploadCurriculumFile(
    file: File
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Error desconocido al eliminar del storage",
      };
    }
  }
