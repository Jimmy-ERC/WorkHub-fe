...
export class EnterpriseViewCandidatesController {
  ...
  private async loadCandidates() {
    ...
    const candidates = (await JobApplicationsService.getApplicationsByJobId(
      job_id
    )) as any;
  ...
  public renderCandidates(): void {
    ...
    document.getElementById("nombreVacante")!.innerText =
      ...
      "Sin candidatos para esta vacante";
...
window.enterpriseViewCandidatesController =
  new EnterpriseViewCandidatesController();
